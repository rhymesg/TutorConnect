...
export const metadata: Metadata = {
  ...
  description: 'Les artikler om undervisning, læring og utdanning på TutorConnect sin blog.',
  alternates: {
    canonical: 'https://tutorconnect.no/blog',
    languages: {
  ...
  openGraph: {
    title: 'Blog - TutorConnect',
    description: 'Les artikler om undervisning, læring og utdanning på TutorConnect sin blog.',
    url: 'https://tutorconnect.no/blog',
...
export default function BlogPage() {
  const structuredData = {
    ...
    "@type": "Article",
    "headline": "De beste nettstedene for privatundervisning i Norge (2025)",
    "description": "Privatundervisning blir stadig mer vanlig i Norge. Her er en oversikt over de mest brukte plattformene for å finne lærere og studenter.",
    "image": "https://tutorconnect.no/images/blog-privatundervisning-norge.jpg",
    "author": {
      "@type": "Organization",
      "name": "TutorConnect",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://tutorconnect.no/blog"
    },
    "keywords": ["privatundervisning", "Norge", "lærere", "studenter", "TutorConnect", "MentorNorge", "Superprof", "UNAK", "leksehjelp", "privatlærer"],
    "inLanguage": "no-NO"
  };
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center relative">
            ...
            <p className="text-lg text-gray-600 mb-4">
              Artikler om undervisning, læring og utdanning
            </p>
            <Link
              href="/blog/en"
      ...
      <article className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-lg prose-gray max-w-none">
          ...
          <p>
            <a href="https://tutorconnect.no" className="text-brand-600 hover:text-brand-700 font-medium">TutorConnect</a> er en ny norsk plattform som gjør det mulig for både lærere og elever å legge ut annonser. Plattformen har innebygd chat og kalenderfunksjon for å avtale timer.
          </p>
