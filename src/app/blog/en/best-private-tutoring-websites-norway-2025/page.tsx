...
export const metadata: Metadata = {
  title: 'Best Private Tutoring Websites in Norway (2025) - TutorConnect Blog',
  description: 'Complete guide to the most popular private tutoring platforms in Norway. Compare MentorNorge, UNAK, Superprof, and TutorConnect to find the best solution.',
  alternates: {
    canonical: 'https://tutorconnect.no/blog/en/best-private-tutoring-websites-norway-2025',
    languages: {
  ...
  openGraph: {
    title: 'Best Private Tutoring Websites in Norway (2025)',
    description: 'Complete guide to the most popular private tutoring platforms in Norway. Compare MentorNorge, UNAK, Superprof, and TutorConnect.',
    url: 'https://tutorconnect.no/blog/en/best-private-tutoring-websites-norway-2025',
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/blog/de-beste-nettstedene-for-privatundervisning-i-norge-2025"
      ...
      <article className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="prose prose-lg prose-gray max-w-none">
          ...
          <p>
            TutorConnect is a new Norwegian platform that allows both teachers and students to post advertisements. The platform has built-in chat and calendar functionality to schedule lessons.
          </p>
