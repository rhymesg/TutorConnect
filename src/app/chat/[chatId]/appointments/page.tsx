...
export default function ChatAppointmentsPage() {
  ...
  const t = {
    no: {
      title: 'Avtaler for denne chatten',
      backToChat: 'Tilbake til chat',
      noAppointments: 'Ingen avtaler enda',
      noAppointmentsDesc: 'Dere har ingen planlagte avtaler for denne chatten',
      pending: 'Venter',
      confirmed: 'Bekreftet',
    ...
    en: {
      title: 'Appointments for this chat',
      backToChat: 'Back to chat',
      noAppointments: 'No appointments yet',
      noAppointmentsDesc: 'You have no scheduled appointments for this chat',
      pending: 'Pending',
      confirmed: 'Confirmed',
  ...
  const fetchAppointments = async () => {
    try {
      ...
      // Fetch appointments for specific chat
      const response = await fetch(`/api/appointments?chatId=${chatId}`, {
        headers: {
  ...
  const handleAppointmentClick = (appointment: Appointment) => {
    // Close current window and navigate parent to chat
    if (window.opener) {
